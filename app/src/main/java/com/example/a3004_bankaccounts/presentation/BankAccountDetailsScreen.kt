...
fun BankAccountDetailsScreenRoot(modifier: Modifier = Modifier) {
    ...
    BankAccountDetailsScreen(state = state, accountId = accountId, modelProducer = modelProducer)
}
...
fun BankAccountDetailsScreen(
    ...
    val dateLabel = remember(state.datePickerDate) {
        // tämä muuttaa Long-tietotyypin millisekunnit LocalDate-tietotyyppiseksi timestampiksi
    ...
    Scaffold(bottomBar = {
        ...
        Box(
            ...
            when {
                ...
                else -> AccountChart(modelProducer = modelProducer, step = "DAY")
            }
        }
    }
}
...
fun AccountChart(
    ...
    // CartesianChartHost on juuricomposable
